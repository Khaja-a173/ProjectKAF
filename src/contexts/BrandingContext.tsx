...
const notifyBrandingSubscribers = () => {
  ...
  brandingSubscribers.forEach(callback => callback({ ...globalBrandingState }))
}

export const updateGlobalBranding = (updater: (prev: BrandingConfig) => BrandingConfig) => {
...
export function BrandingProvider({ children, tenantId, locationId }: BrandingProviderProps) {
