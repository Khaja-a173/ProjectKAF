            ...
            headers.forEach((header, index) => {
              ...
              switch (header.toLowerCase()) {
                ...
                case 'tags':
                  ...
                  break
                case 'allergens':
                  item.allergens = value ? value.split(';').map(a => a.trim()) : []
                  break
                case 'vegetarian':
                case 'isvegetarian':
                  item.isVegetarian = value.toLowerCase() === 'true' || value === '1'
                  break
                case 'vegan':
                case 'isvegan':
                  item.isVegan = value.toLowerCase() === 'true' || value === '1'
                  break
                case 'spicylevel':
                case 'spicy_level':
            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <ul className="text-sm text-blue-800 space-y-1">
                  ...
                  <li>• Optional: description, cost, imageUrl, tags, allergens, dietary info</li>
