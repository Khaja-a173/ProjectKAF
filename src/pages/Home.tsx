...
export default function Home() {
  ...
  const hasCustomContent = homePage && 
    homePage.sections.length > 0 && 
    homePage.sections.some(s => s.visible && s.props && Object.keys(s.props).length > 0)
  ...
  const features = [
    {
      icon: ChefHat,
      title: 'Expert Chefs',
      description: 'Our world-class chefs create culinary masterpieces with passion and precision.'
    },
    {
      icon: Award,
      title: 'Award Winning',
    ...
    },
    {
      ...
      description: 'Intimate dining for couples or spacious areas for larger celebrations.'
    },
    {
      icon: Heart,
      title: 'Made with Love',
      description: 'Every dish is prepared with care using the finest, freshest ingredients.'
    }
  ]
  ...
  const testimonials = [
    {
      name: 'Sarah Johnson',
      rating: 5,
      comment: 'Absolutely incredible dining experience! The ambiance, service, and food were all perfect.',
      image: 'https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=100'
    },
    {
      name: 'Michael Chen',
      rating: 5,
      comment: 'Best restaurant in the city! The chef\'s special was outstanding and the staff was amazing.',
      image: 'https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?auto=compress&cs=tinysrgb&w=100'
    },
    {
      name: 'Emily Rodriguez',
      rating: 5,
      comment: 'Perfect for our anniversary dinner. Romantic atmosphere and exceptional cuisine.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience the perfect blend of exceptional cuisine, elegant ambiance, and impeccable service
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Discover our chef's most celebrated creations</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: 'Premium wagyu beef with truffle sauce and roasted potatoes',
                price: '$45',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              ...
              <p className="text-gray-300">123 Gourmet Street<br />Culinary District, CD 12345</p>
            </div>
            <div>
              <Phone className="w-8 h-8 text-orange-500 mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2">Call Us</h3>
              <p className="text-gray-300">+1 (555) 123-4567<br />Reservations & Inquiries</p>
            </div>
            <div>
              <Clock className="w-8 h-8 text-orange-500 mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2">Hours</h3>
              <p className="text-gray-300">Mon-Thu: 5PM-10PM<br />Fri-Sat: 5PM-11PM<br />Sun: 4PM-9PM</p>
            </div>
          </div>
        </div>
      </section>
