...
export default function Gallery() {
  ...
  const hasCustomContent = galleryPage && 
    galleryPage.sections.length > 0 && 
    galleryPage.sections.some(s => s.visible && s.props && Object.keys(s.props).length > 0)
  ...
  const galleryImages = [
    ...
    },
    {
      ...
      description: 'Elegant dining space with warm ambiance and crystal chandeliers',
      ...
      <section id="gallery-section" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">A visual journey through our culinary world</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-gray-300 mb-12">
                Celebrating milestones that define our excellence and commitment to culinary artistry.
              </p>
