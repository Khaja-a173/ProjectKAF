    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {pages.map(page => (
            <div key={page.id} className="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {pageTemplates.map(template => {
            ...
            return (
              <div key={template.slug} className="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-gray-500">{sectionRegistry[section.type]?.name}</div>
                      </div>
                    </div>
                ...
                {selectedPage.sections.filter(s => s.visible).map(section => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-xs text-gray-500">{sectionRegistry[section.type]?.name}</span>
                    </div>
                    ...
                    {section.type === 'contact_block' && (
                      <div className="space-y-2">
                        <p className="text-sm"><strong>Address:</strong> {section.props.address}</p>
                        <p className="text-sm"><strong>Phone:</strong> {section.props.phone}</p>
                        <p className="text-sm"><strong>Email:</strong> {section.props.email}</p>
                      </div>
                    )}
                    
                    {section.type === 'rich_text' && (
                      <div className="prose prose-sm" dangerouslySetInnerHTML={{ __html: section.props.content }} />
                    )}
        ...
        <div className="lg:col-span-1">
          {selectedSection ? (
            <SectionInspector
              ...
              onToggleVisibility={() => 
                updateSection(selectedPage.id, selectedSection.id, { visible: !selectedSection.visible })
              }
            />
          ) : (
            <div className="bg-white rounded-xl shadow-sm p-6">
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm p-6 sticky top-4">
      <div className="flex items-center justify-between mb-6">
        ...
        >
          {section.visible ? <Eye className="w-4 h-4" /> : <Eye className="w-4 h-4" />}
        </button>
      </div>
