                ...
                <div key={key} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      ...
                      {key === 'lowStock' && 'Alert when inventory items are running low'}
                      {key === 'dailyReports' && 'Receive daily performance summaries'}
                      {key === 'marketing' && 'Updates about new features and promotions'}
                    </p>
                  </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {[
                ...
                { name: 'Sarah Johnson', email: 'sarah@restaurant.com', role: 'Manager' },
                { name: 'Mike Wilson', email: 'mike@restaurant.com', role: 'Staff' },
              ].map((member, index) => (
          ...
          <div className="space-y-6">
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              <div className="flex">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-green-800">Current Plan: Professional</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="mb-8">
          <div className="flex space-x-8">
            ...
            <Link to="/settings" className="text-blue-600 border-b-2 border-blue-600 pb-2 font-medium">
              Settings
            </Link>
          </div>
        </nav>
