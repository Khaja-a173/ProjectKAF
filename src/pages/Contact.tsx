...
export default function Contact() {
  ...
  const hasCustomContent = contactPage && 
    contactPage.sections.length > 0 && 
    contactPage.sections.some(s => s.visible && s.props && Object.keys(s.props).length > 0)
  ...
  const faqItems = [
    {
      ...
      answer: "Yes, we welcome walk-ins! However, we highly recommend making a reservation to ensure table availability, especially during peak hours and weekends."
    },
    {
      question: "How do I book private events?",
      answer: "For private events, please contact us directly at +91 9380005430 or email contact@projectkaf.app. Our events team will work with you to create a customized experience."
    },
    {
      question: "Do you provide catering services?",
      answer: "Yes, we offer full catering services for corporate events, weddings, and special occasions. Contact us to discuss your catering needs and menu options."
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">172 VENNER RD, YERONGA, BRISBANE, Australia-4104</p>
                </div>
              </div>
              ...
              <div className="pt-6 border-t border-gray-200">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="#" className="w-10 h-10 bg-sky-100 rounded-full flex items-center justify-center hover:bg-sky-200 transition-colors">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-2xl p-12 text-white text-center mb-20">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-4xl font-bold mb-4">Planning a Special Evening?</h2>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Find answers to common questions about our restaurant</p>
            </div>
