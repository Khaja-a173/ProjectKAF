...
import { Calendar, Clock, Users, Star, MapPin, Phone, CheckCircle2 } from 'lucide-react'
...
export default function Reserve() {
  ...
  const tableOptions = [
    { id: 'window', name: 'Window Table', description: 'Perfect for romantic dinners', premium: true },
    { id: 'private', name: 'Private Booth', description: 'Intimate dining experience', premium: true },
    { id: 'main', name: 'Main Dining', description: 'Central restaurant atmosphere', premium: false },
    { id: 'patio', name: 'Patio Seating', description: 'Outdoor dining experience', premium: false },
  ]
  ...
  const specialPackages = [
    {
      ...
      price: 150,
      includes: ['3-course meal', 'Wine pairing', 'Roses & candles', 'Live music'],
      image: 'https://images.pexels.com/photos/1581384/pexels-photo-1581384.jpeg?auto=compress&cs=tinysrgb&w=400'
    },
    {
      name: 'Chef\'s Tasting',
      price: 120,
      includes: ['7-course tasting', 'Wine selection', 'Chef interaction', 'Recipe cards'],
      image: 'https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg?auto=compress&cs=tinysrgb&w=400'
    },
    {
      name: 'Business Lunch',
      price: 85,
      includes: ['Express service', 'Private seating', 'WiFi access', 'Coffee included'],
    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Quick Reservation</h2>
        ...
        {/* Special Packages */}
        <div className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Special Dining Experiences</h2>
        ...
        {/* Table Options */}
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Choose Your Table</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">Exceptional service with attention to every detail</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Located in the heart of the culinary district</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Round-the-clock customer service for your needs</p>
          </div>
        </div>
      </div>
