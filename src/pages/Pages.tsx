...
export default function Pages() {
  ...
  const aboutContent = {
    story: "Founded in 2010, Bella Vista has been a cornerstone of fine dining in our community. Our passion for exceptional cuisine and warm hospitality has made us a beloved destination for food enthusiasts and special occasions alike.",
    mission: "To create unforgettable dining experiences through innovative cuisine, exceptional service, and a warm, welcoming atmosphere that brings people together.",
    values: [
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Absolutely! We can accommodate vegetarian, vegan, gluten-free, and other dietary needs. Please inform us when making your reservation."
    },
    {
      question: "What is your dress code?",
      answer: "We have a smart casual dress code. We ask that guests avoid shorts, flip-flops, and athletic wear during dinner service."
    },
    {
      question: "Do you offer private dining?",
      answer: "Yes, we have private dining rooms available for special events, business meetings, and celebrations. Contact us for more details."
    },
    {
      question: "Is parking available?",
      answer: "We offer complimentary valet parking for all guests during dinner service. Street parking is also available."
    }
  ]
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-64 flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white">
          ...
          <p className="text-xl">Everything you need to know about Bella Vista</p>
        </div>
      </section>
          ...
          {pageLinks.map((page, index) => (
            <div key={index} className="group cursor-pointer">
              <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
                <div className={`w-12 h-12 bg-gradient-to-r ${page.color} rounded-lg flex items-center justify-center mb-4`}>
              ...
              {awards.map((award, index) => (
                <div key={index} className="flex items-center p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-orange-600 font-medium">{award.year}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">+1 (555) 123-4567<br />Reservations & Inquiries</p>
              </div>
              
              <div className="text-center">
                <Mail className="w-8 h-8 text-orange-500 mx-auto mb-4" />
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Email Us</h3>
                <p className="text-gray-600">info@bellavista.com<br />events@bellavista.com</p>
              </div>
            </div>
          </div>
        </section>
