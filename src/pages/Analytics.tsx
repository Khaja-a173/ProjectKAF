...
import { ChefHat, TrendingUp, DollarSign, Users, Clock, BarChart3 } from 'lucide-react'

export default function Analytics() {
  const metrics = [
    { name: 'Revenue Today', value: '$2,847', change: '+12.5%', trend: 'up' },
    { name: 'Orders Today', value: '156', change: '+8.2%', trend: 'up' },
    { name: 'Avg Order Value', value: '$18.25', change: '-2.1%', trend: 'down' },
            ...
            <div key={metric.name} className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
              <div className="flex items-center justify-between">
                ...
                <div className={`p-3 rounded-lg ${
                  ...
                  <TrendingUp className={`w-6 h-6 ${metric.trend === 'down' ? 'rotate-180' : ''}`} />
                </div>
              </div>
